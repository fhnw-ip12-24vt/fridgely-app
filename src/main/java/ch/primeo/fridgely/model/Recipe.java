...
public class Recipe {
     ...
     * Hibernate will map this to "recipe_id" column
     */
    @Id // Mark as primary key
    private int recipeId;

    /**
     * Base name of the recipe (e.g., English).
     * Hibernate will map this to "name" column
     */
    private String name;

    /**
     * German name of the recipe.
     * Hibernate will map this to "name_de" column
     */
    private String nameDE;

    /**
     * French name of the recipe.
     * Hibernate will map this to "name_fr" column
     */
    private String nameFR;

    /**
     * Base description of the recipe.
     * Hibernate will map this to "description" column
     */
    private String description;

    /**
     * German description of the recipe.
     * Hibernate will map this to "description_de" column
     */
    private String descriptionDE;

    /**
     * French description of the recipe.
     * Hibernate will map this to "description_fr" column
     */
    private String descriptionFR;

    /**
     * List of ingredients associated with this recipe.
     * Mapped by the 'recipe' field in the RecipeIngredient entity.
     */
    ...
    /**
     * Constructs a new Recipe with essential information.
     * Note: This constructor might need adjustment based on actual usage or removed if only default constructor is needed.
