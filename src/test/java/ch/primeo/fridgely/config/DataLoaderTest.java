...
class DataLoaderTest {
    ...
    void run_shouldExecuteDatabasePopulatorWithCorrectDataSource() throws Exception {
        ...
        try (MockedStatic<DatabasePopulatorUtils> populatorUtilsMockedStatic = Mockito.mockStatic(
                DatabasePopulatorUtils.class)) {
            ...
            populatorUtilsMockedStatic.verify(
                    () -> DatabasePopulatorUtils.execute(populatorCaptor.capture(), // Capture the populator instance
    ...
    @Test
    void run_whenScriptExecutionFails_shouldPropagateException() {
        // Arrange
        ...
        try (MockedStatic<DatabasePopulatorUtils> populatorUtilsMockedStatic = Mockito.mockStatic(
            ...
            RuntimeException thrown = assertThrows(RuntimeException.class, () -> dataLoader.run());
            ...
            assertEquals(scriptExecutionException, thrown.getCause(),
                    "The cause should be the original scriptExecutionException.");
        }
    }
    ...
    void run_whenDataSourceConnectionFails_shouldPropagateException() throws SQLException {
        ...
        assertEquals(org.springframework.jdbc.datasource.init.UncategorizedScriptException.class,
                thrown.getCause().getClass(), "Cause of RuntimeException should be UncategorizedScriptException.");
        ...
        assertNotNull(cannotGetJdbcConnectionException.getCause(),
                "CannotGetJdbcConnectionException should have a cause.");
